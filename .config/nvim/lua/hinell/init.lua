...
require("hinell.plugins.nvim"):init(pm.extended({ category = "nvim", description = "nvim api related plugins" }))
...
-- CONTINUE: [October 09, 2023] fix this piece of crap!!
...
-- NOTE: Uncomment if you are using packer.nvim; for lazy.nvim,
-- Use colorscheme twice to update colorscheme!
