				...
				legendary.keymaps({
					{
						...
						keymaps = {
							...
							{ mode = { "n" }, description="Editor: git: hunk: prev", "<C-g>ha", gitsigns.stage_hunk },
							{ mode = { "v" }, description="Editor: git: hunk: prev", "<C-g>ha", gitsigns.stage_selection},
							{ mode = { "n" }, description="Editor: git: hunk: prev", "<C-g>hr", gitsigns.reset_hunk },
							{ mode = { "v" }, description="Editor: git: hunk: prev", "<C-g>hr", gitsigns.reset_selection },
							{ mode = { "n" }, description="Editor: git: hunk: prev", "<C-g>hu", gitsigns.undo_stage_hunk }
						}
					}
				})
			end
