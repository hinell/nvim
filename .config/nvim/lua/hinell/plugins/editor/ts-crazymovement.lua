				  ...
				  local keymaps ={
					  {
						  ...
						  keymaps = {
							  ...
							  , { mode = { "n" }, description="Editor: ast: node: focus parent (ts-crazymove)"       ,	"<M-j>",node_movement.move_up }
							  , { mode = { "n" }, description="Editor: ast: node: focus child (ts-crazymove)"        ,	"<M-k>",node_movement.move_down }
							  ...
							  , { mode = { "v" }, description="Editor: ast: node: select parent (ts-crazymove)"      ,	"<M-j>",node_movement.select_up }
							  , { mode = { "v" }, description="Editor: ast: node: select child (ts-crazymove)"       ,	"<M-k>",node_movement.select_down }
