			...
			if legendaryIsOk then
				local keymaps = {
					...
					keymaps = {
						...
						, { mode = {"n", "v" }, "<M-k>", function() treeClimber.goto_parent(opts) end , opts = keyopts }
						, { mode = {"n", "v" }, "<M-j>", function() treeClimber.goto_child (opts) end , opts = keyopts }
				...
				vim.keymap.set({"n", "v" }, "<M-k>", function() treeClimber.goto_parent(opts) end , keyopts)
				vim.keymap.set({"n", "v" }, "<M-j>", function() treeClimber.goto_child (opts) end , keyopts)
