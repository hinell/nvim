...
M.pm.config = function()
	...
	local nvimTreeSetupKeymapsFn = function(auEvent)
		...
		local nvimTreeKeymap = {
			...
			{ mode = { "n" }, "gP"           , api.node.navigate.parent          , opts = opts("navigate: parent directory") },
			...
			{ mode = { "n" }, "-"     , api.tree.change_root_to_parent  , opts = opts("tree: up") },
			...
			require("legendary").keymaps({
				{
					...
					description = "nvim-tree local keymaps",
