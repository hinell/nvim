...
-- TODO: [March 26, 2025] Remove this package path hack
local packagePath = package.path;
package.path = package.path .. ";" .. vim.env.HOME .. "/.local/share/nvim/lazy/lua-std.nvim/lua/?/init.lua"
package.path = package.path .. ";" .. vim.env.HOME .. "/.local/share/nvim/lazy/lua-std.nvim/lua/?.lua"
local std = require("lua-std")
