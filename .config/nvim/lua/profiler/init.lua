...
table.insert(M.jit.commands, {
	 "JITProfilerStart",
	 function(args) M.jit:start({ filepath = args.args }) end,
	 {
...
table.insert(M.jit.commands, {
	 "JITProfilerStop",
	 function(args) M.jit:stop(args) end,
	 {
		desc  = "Start LuaJIT built in profiler",
		force = true,
		bar   = true,
...
table.insert(M.jit.commands, {
	 "JITProfilerToggle",
	 function(args) M.jit:toggle({ filepath = args.args }) end,
	 {
		desc  = "Start LuaJIT built in profiler",
		force = true,
		bar   = true,
...
table.insert(M.jit.commands, {
	 "JITProfilerStatus",
	 function(args) print(("%s: status: %s"):format("JITProfiler", M.jit._running and "running" or "stopped")) end,
	 {
		desc  = "Start LuaJIT built in profiler",
		force = true,
		bar   = true,
