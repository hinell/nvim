...
| Mode | Keymap | Description |
|-|-|-|
| nv | <kbd>ALT+UP</kbd> | Ast: highlight & jumpt to the parent node |
| nv | <kbd>ALT+DOWN</kbd> | Ast: highlight & jumpt to the child node |
| nv | <kbd>ALT+RIGHT</kbd> | Ast: highlight & jumpt to the right node |
| nv | <kbd>ALT+LEFT</kbd> | Ast: highlight & jumpt to the left node |

**MODES:** n - normal, i - insert, v - visual, o - pending, * - any
